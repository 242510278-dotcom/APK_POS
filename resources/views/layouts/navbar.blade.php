<nav class="navbar navbar-expand-lg border-bottom shadow-sm py-2.5" style="background-color: #1a1d20; border-color: #2b3035 !important;">
  <div class="container-fluid px-4">
    <!-- Logo & Brand -->
    <!-- SEBELUMNYA: -->
<!-- <div class="d-flex flex-column lh-1"> ... </div> -->

<!-- UBAH MENJADI SEPERTI INI: -->
<a href="{{ route('toko.sendi') }}" class="d-flex flex-column lh-1 text-decoration-none text-start" style="cursor: pointer;">
